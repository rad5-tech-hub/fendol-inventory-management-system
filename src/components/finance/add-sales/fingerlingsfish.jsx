          ...
          <Col className="mb-4">
            ...
            <div style={{ position: "relative" }}>
              <Form.Control
                ...
                required
              />
              {balance !== undefined && balance !== null && balance !== 0 && fingerlingsData.customerId ? (
                <p className="p-2" style={{ color: balance < 0 ? '#DC2626' : '#16A34A', fontWeight: 600 }}>Balance: ₦{Math.abs(balance).toLocaleString()} {balance < 0 ? '(Debit)' : '(Credit)'}</p>
              ) : (
                ""
              )}
