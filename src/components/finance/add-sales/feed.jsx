                            ...
                            <Form.Group controlId="searchCustomer">
                                ...
                                <div style={{ position: 'relative', width: '100%' }}>
                                    <Form.Control
                                        ...
                                        required
                                    />{balance !== undefined && balance !== null && balance !== 0 && feedData.customerId ? <p className="p-2" style={{ color: balance < 0 ? '#DC2626' : '#16A34A', fontWeight: 600 }}>Balance: ₦{Math.abs(balance).toLocaleString()} {balance < 0 ? '(Debit)' : '(Credit)'}</p> : ''}
