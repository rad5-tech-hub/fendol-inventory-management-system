              ...
              <DataTable
                ...
                columns={[
                  ...
                  { key: 'productName', label: 'PRODUCT', render: (val) => {
                    const text = val || "-";
                    return (
                      <span title={text} style={{ display: 'inline-block', maxWidth: '220px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', verticalAlign: 'bottom' }}>
                        {text}
                      </span>
                    );
                  }},
